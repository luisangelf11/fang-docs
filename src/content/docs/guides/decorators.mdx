...
```typescript
import { Controller, type RouteGroup } from "fang-js";
...
El decorador @Service asegura que tu lógica de negocio esté preparada para recibir el Contexto. En Fang JS, la regla de oro es: el primer argumento de cualquier método de servicio debe ser ctx: Context.

```typescript
import { Service, type Context } from "fang-js";
...
Si quieres llevar el desarrollo al siguiente nivel, utiliza la interfaz IBaseService. Esta interfaz "obliga" a tus métodos a seguir la firma correcta, dándote autocompletado inmediato mientras escribes.

```typescript
import { IBaseService, type Context } from "fang-js";
...
import { Service, IBaseService, Context } from "fang-js";
...
import { Controller, RouteGroup } from "fang-js";
